<%@ WebHandler Language="C#" Class="ImageUpload_old" %>
...
public class ImageUpload_old : IHttpHandler 
{
    ...
    public void ProcessRequest (HttpContext context)
    {
        ...
        try
        {
                ...
                context.Request.Files.Count > 0)
            {
                ...
                else
                {
                    ...
                    string imageFilename = Path.GetFileNameWithoutExtension(context.Request.Files[0].FileName);
                    ...
                    {
                        // Save the image
                        image.Save(serverPath + imageFilename, ImageFormat.Png);
                    }

                    imageFile.name = imageFilename;
                    imageFile.size = fileSize;
                    imageFile.type = "image/png";
                    imageFile.url = virtualPath + imageFile.name;
        ...
        context.Response.Write(filesObject);
    }
