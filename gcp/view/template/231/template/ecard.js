window.ecard.template = {
	...
	_card:{
		...
		_regular:[
		'<div id="card-numbers"><div class="card-number">iTunes Code</div><div class="card-number"></br></div></div>',
			'<div id="card"{{#if card.photo}} class="photo {{card.orientation}} "{{/if}}>',
				'<div class="card-wrapper">',
					'<figure class="large">',
	...
	_numbers:[
		'<div id="card-numbers">',
			'{{#unless merchant.barcode}}',
				'<div class="card-number">Code: {{{card.ecard}}}</div>',
				'<div class="card-number"></br></div>',
				'<div class="card-number"><a href="https://buy.itunes.apple.com/WebObjects/MZFinance.woa/wa/com.apple.jingle.app.finance.DirectAction/freeProductCodeWizard?code={{{card.ecard}}}" target="_blank" style="text-decoration: underline;"> Click here to redem your code</a></div>',
				'<div class="card-number"></br></div>',
				'<div class="card-number">iTunes is a trademark of Apple Inc.</div>',
				'<div class="card-number"></br></div>',
				'<div class="card-number">Apple is not a participant or sponsor of this promotion.</div>',
