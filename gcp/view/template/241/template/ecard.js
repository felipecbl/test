window.ecard.template = {
	...
	_card:{
		...
		_regular:[
		'<div id="card-numbers"><div class="card-number">Amazon eGift Card</div><div class="card-number"></br></div></div>',
			'<div id="card"{{#if card.photo}} class="photo {{card.orientation}} "{{/if}}>',
				'<div class="card-wrapper">',
					'<figure class="large">',
	...
	_actions:[
		'<div class="actions no-printing">',
			...
			'<a type="application/vnd.apple.pkpass" class="button" id="action-passbook" title="{{{actions.description.passbook}}}" href="{{{merchant.passbookUrl}}}" rel="sidebar">{{{actions.label.passbook}}}</a>',
	...
	_numbers:[
		'<div id="card-numbers">',
			'{{#unless merchant.barcode}}',
				'<div class="card-number">Claim Code: {{{card.ecard}}}</div>',
				'<div class="card-number"></br></div>',
				'<div class="card-number"><a href="https://www.amazon.ca/gp/css/gc/payment/view-gc-balance?code=" target="_blank" style="text-decoration: underline;"> Click here to redem your code</a></div>',
				'<div class="card-number"></br></div>',
				'<div class="card-number" style="text-align: left;">Redeeming your<a href="http://amazon.ca/" target="_blank" style="text-decoration: underline;">Amazon.ca</a> Gift Certificate</div>',
				'<div class="card-number"></br></div>',
				'<div class="card-number" style="text-align: left;">1. Visit www.amazon.ca/redeemgift.</div>',
				'<div class="card-number" style="text-align: left;">2. Enter the Claim Code and click Apply to Your Account.</div>',
			'{{/unless}}',
		'</div>'
	].join('\n'),
